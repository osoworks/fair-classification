...
def test_bank_data():
    ...
    """ Load the adult data """
    X, y, x_control = load_bank_data() # set the argument to none, or no arguments if you want to test with the whole data -- we are subsampling for performance speedup
